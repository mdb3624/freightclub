...
gcloud run deploy freightclub-backend \
  ...
  --set-env-vars='DB_URL=jdbc:postgresql://ep-lively-tree-amv4cqt0-pooler.c-5.us-east-1.aws.neon.tech/freightclub_db?sslmode=require&currentSchema=freightclub'
