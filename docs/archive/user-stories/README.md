...
See [phase-1-core-load-lifecycle.md](docs/archive/user-stories/phase-1-core-load-lifecycle.md) for full narrative.

### Standard: Built (8 stories)

| ID | Title | Persona |
|----|-------|---------|
| [S-001](S-001.md) | Shipper Registration | Shipper |
| [S-002](S-002.md) | Default Pickup Location | Shipper |
| [S-003](S-003.md) | Notification Preferences | Shipper |
| [S-004](S-004.md) | Company Join Code | Shipper |
| [T-001](T-001.md) | Trucker Registration | Trucker |
| [T-002](T-002.md) | Trucker Cost Profile Setup | Trucker |
| [T-005](T-005.md) | CPM and Minimum RPM Display | Trucker |
| [T-006](T-006.md) | 30-Day Earnings Summary | Trucker |

---

## Phase 1.1 — UX Hardening ✅ Complete

See [phase-1.1-ux-hardening.md](docs/archive/user-stories/phase-1.1-ux-hardening.md) for full narrative.

### Tier 1 — HF-CRITICAL (4 stories) ✅ All Built

| ID | Title | Persona |
|----|-------|---------|
| [S-005](S-005.md) | State Code Dropdown — origin/destination stored as validated 2-letter code | Shipper |
| [S-006](S-006.md) | Cancel Load Confirmation Dialog — destructive action requires explicit confirm | Shipper |
| [T-007](T-007.md) | HOS 70-Hour/8-Day Cycle Tracking — FMCSA rolling cycle entirely absent | Trucker |
| [T-017](T-017.md) | HOS Widget: 70-Hour/8-Day Cycle on Load Execution View | Trucker |
...
| ID | Title |
|----|-------|
| [DB-001](DB-001.md) | Resize `origin_state` / `destination_state` to `CHAR(2)` + CHECK constraint |
| [DB-002](DB-002.md) | Add `DEFAULT CURRENT_TIMESTAMP` / `ON UPDATE` to `loads.created_at` / `updated_at` |
| [DB-003](DB-003.md) | Foreign key: `loads.trucker_id` → `users.id` |

### Tier 3 — HF (16 stories) ✅ All Built

| ID | Title | Persona |
|----|-------|---------|
| [S-007](S-007.md) | Address Field Order Correction (street → city → state → zip) | Shipper |
| [S-008](S-008.md) | Cross-Field Date Validation (pickup/delivery window ordering) | Shipper |
| [S-009](S-009.md) | Pickup/Delivery Window Label Rename (eliminate "from" ambiguity) | Shipper |
| [S-010](S-010.md) | Shipper Dashboard Status Summary Strip | Shipper |
| [S-011](S-011.md) | Weight Field Contextual Hint ("Legal max: 80,000 lbs") | Shipper |
| [T-003](T-003.md) | Cost Profile Setup CTA — elevated prompt when profile is missing | Trucker |
| [T-004](T-004.md) | RPM Display Precision — show 2 decimal places, not 4 | Trucker |
| [T-009](T-009.md) | Filter State Persisted in URL — survive back-navigation | Trucker |
| [T-010](T-010.md) | Equipment Filter Unlockable — allow browsing other trailer types | Trucker |
| [T-012](T-012.md) | Profitability Card Visible on Claimed Load | Trucker |
| [T-015](T-015.md) | Toast Confirmation After Claim | Trucker |
| [T-016](T-016.md) | Clear Explanation When Claim Is Blocked (active load exists) | Trucker |
| [T-018](T-018.md) | HOS On-Duty Bar Renders Before Start Time Is Entered | Trucker |
| [T-019](T-019.md) | HOS Proactive Warnings at 4-Hour and 2-Hour Thresholds | Trucker |
| [P-001](P-001.md) | Shared App Shell / Layout Component | Platform |
| [P-002](P-002.md) | URL-Based Filter State for Load Board | Platform |

### Tier 4 — DB (7 stories) ✅ All Built

| ID | Title | Enables |
|----|-------|---------|
| [DB-004](DB-004.md) | Introduce `claims` table | Ratings, cancellation notifications, bidding |
| [DB-005](DB-005.md) | CHECK constraints for `loads` enum columns | Data integrity |
| [DB-006](DB-006.md) | Load board query indexes | Load board performance at scale |
| [DB-007](DB-007.md) | `loads.payment_terms` NOT NULL | Payment integrity |
| [DB-009](DB-009.md) | Create `load_events` table | Status timeline, notifications |
| [DB-010](DB-010.md) | Scope `users.email` uniqueness to tenant | Multi-role accounts |
| [DB-011](DB-011.md) | Add `refresh_tokens.revoked_at` column | Security audit trail |

---

## Phase 1.2 — Security & Stability Hardening ✅ Complete

See [phase-1.2-security-hardening.md](docs/archive/user-stories/phase-1.2-security-hardening.md) for full narrative.

### Security (7 stories) ✅ All Built

| ID | Title |
|----|-------|
| [SEC-001](SEC-001.md) | Race Condition Fix — load claiming (`SELECT FOR UPDATE`) |
| [SEC-002](SEC-002.md) | Race Condition Fix — refresh token rotation |
| [SEC-003](SEC-003.md) | Rate Limiting on Auth Endpoints (Bucket4j token bucket) |
| [SEC-004](SEC-004.md) | JWT `iss` and `aud` Claims — issue and validate on every request |
| [SEC-005](SEC-005.md) | JWT Secret to Environment Variable — remove from committed config |
| [SEC-006](SEC-006.md) | Remove Hardcoded Tailscale Domain from `vite.config.ts` |
| [SEC-007](SEC-007.md) | CORS Explicit Header Whitelist — replace `allowedHeaders: ["*"]` |

### Bug Fixes (5 stories) ✅ All Built

| ID | Title |
|----|-------|
| [BUG-001](BUG-001.md) | Write `claims` Row on Every Claim and Release |
| [BUG-002](BUG-002.md) | Write `load_events` Row on Every Status Transition |
| [BUG-003](BUG-003.md) | Date Comparison Fix — use `new Date()` not string ordering |
| [BUG-004](BUG-004.md) | URL Filter Enum Guard — validate params before cast |
| [BUG-005](BUG-005.md) | Server-Side Overweight Load Validation |

### Infrastructure (4 stories) ✅ All Built

| ID | Title |
|----|-------|
| [INF-001](INF-001.md) | React `<ErrorBoundary>` in `App.tsx` |
| [INF-002](INF-002.md) | Spring Boot Actuator — `/health` and `/info` endpoints |
| [INF-003](INF-003.md) | Production Environment Config (`application-prod.yml`) |
| [INF-004](INF-004.md) | Structured Logging with Correlation IDs |

### Testing (5 stories) ✅ All Built

| ID | Title |
|----|-------|
| [TST-001](TST-001.md) | `AuthService` Unit Tests — register, login, refresh, logout |
| [TST-002](TST-002.md) | `RefreshTokenService` Unit Tests — rotation and revocation |
| [TST-003](TST-003.md) | `JwtAuthenticationFilter` Unit Tests |
| [TST-004](TST-004.md) | Claim Load Concurrency Integration Test |
| [TST-005](TST-005.md) | Frontend Claim Flow Smoke Tests |

---

## Phase 2 — Notifications & Status Timeline 🔜 Next

See [phase-2-notifications.md](docs/archive/user-stories/phase-2-notifications.md) for full narrative.

| ID | Title | Persona |
|----|-------|---------|
| [S-028](S-028.md) | Email Notification — Load Claimed | Shipper |
| [S-029](S-029.md) | Email Notification — Load Picked Up | Shipper |
| [S-030](S-030.md) | Email Notification — Load Delivered | Shipper |
| [S-031](S-031.md) | Cancel Load with Reason | Shipper |
| [S-032](shipper/S-032.md) | Load Status Timeline View | Shipper |
| [T-024](T-024.md) | Email Notification — Load Cancelled by Shipper | Trucker |
| [T-025](T-025.md) | Active Load Slot Freed on Shipper Cancellation | Trucker |
| [P-003](P-003.md) | In-App Notification Bell with Unread Count | Platform |
| [P-004](P-004.md) | SMS Notifications (opt-in, Twilio) | Platform |
| [P-005](P-005.md) | EIA Diesel Price Backend Proxy + Cache | Platform |
| [T-026](T-026.md) | Live Diesel Price Market Ticker | Trucker |
| [T-027](T-027.md) | EIA Fuel Surcharge Auto-Populate in Profitability Analyzer | Trucker |

---

## Phase 3 — Document Management (BOL & POD)

See [phase-3-documents.md](docs/archive/user-stories/phase-3-documents.md) for full narrative.
...
See [phase-4-ratings.md](docs/archive/user-stories/phase-4-ratings.md) for full narrative.
...
See [phase-5-payments.md](docs/archive/user-stories/phase-5-payments.md) for full narrative.
...
See [phase-6-messaging.md](docs/archive/user-stories/phase-6-messaging.md) for full narrative.
...
See [phase-7-carrier-management.md](docs/archive/user-stories/phase-7-carrier-management.md) for full narrative.
...
| [T-008](T-008.md) | Load Board Sorting — by RPM, distance, pickup date | Trucker |
| [T-011](T-011.md) | Pickup Date Urgency Signal — highlight loads picking up < 24 hr | Trucker |
...
See [phase-7b-financial-intelligence.md](docs/archive/user-stories/phase-7b-financial-intelligence.md) for full narrative.
...
| [DB-008](DB-008.md) | Extract `trucker_cost_profiles` Table from `users` | Platform |

---

## Phase 8 — Bidding

See [phase-8-bidding.md](docs/archive/user-stories/phase-8-bidding.md) for full narrative.
...
See [phase-9-admin.md](docs/archive/user-stories/phase-9-admin.md) for full narrative.
