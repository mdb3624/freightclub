...
| US-883 | Platform Health Alerting (Webhook) | DONE | 9 | US-752 | P1 — Slack/email webhook, debounced, fail-open. Shipped 2026-09-02; alert evaluation is bolted directly onto `PlatformHealthService.getHealth()`'s existing 10s-cached computation (no new scheduler). Story doc: `docs/business/stories/US-883_Platform_Health_Alerting.md` | Jira: FREIG-146 |
| US-884 | Super User: Tenant Suspend/Deactivate | DONE | 9 | US-874, US-880 | P2 — access lock only, no billing/plan/deletion. Shipped 2026-09-02; tenant-level `is_suspended` is independent of and layered on top of US-881's user-level flag, checked first in `AuthService.login()`. Story doc: `docs/business/stories/US-884_Super_User_Tenant_Suspend_Deactivate.md` | Jira: FREIG-147 |
| US-885 | Super User: Scoped User Impersonation | DONE | 9 | US-874, US-880, US-881 | P3 — ships last, deliberately; time-boxed, re-auth, audit-logged. Shipped 2026-09-02; view-only enforced via JwtAuthenticationFilter, no frontend banner (backend-only, matching this batch's precedent). Story doc: `docs/business/stories/US-885_Super_User_Scoped_Impersonation.md` | Jira: FREIG-148 |
