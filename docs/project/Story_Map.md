...
| US-860 | Home Page CTA Simplification & In-Page Signup Modal | READY_FOR_DESIGN | Cross | US-855 | BA Gate 1 approved in chat 2026-07-22 (see `docs/business/stories/US-860_Home_Page_CTA_Simplification_And_Signup_Modal.md`). Follow-up to US-855: remove header "Get Started Free" CTA + persona-split "Find Loads"/"Post a Load" CTAs; remaining "Get Started Free" CTAs open a new in-page Signup modal (reuses existing RegisterForm/register API, no backend changes); Login/Signup modals switch to each other in place. | Jira: FREIG-120 |
