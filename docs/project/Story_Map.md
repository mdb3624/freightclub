...
| ID     | Title                                  | Status      | Phase | Depends On | Guardrails |
| :----- | :------------------------------------- | :---------- | :---- | :--------- | :--------- |
| US-880 | Super User Audit Log (Foundation) | DONE | 9 | US-874 | P0 — precondition for US-881/882/884/885; append-only enforced at DB grant level. Shipped 2026-09-02, backend + frontend (Audit Log tab). Story doc: `docs/business/stories/US-880_Super_User_Audit_Log_Foundation.md` | Jira: FREIG-143 |
| US-881 | Super User: Suspend/Reactivate User + Force Password Reset | DONE | 9 | US-874, US-880 | P0 — highest council consensus. New `is_suspended` field, session invalidation. Shipped 2026-09-02, backend + frontend (Users tab). Story doc: `docs/business/stories/US-881_Super_User_Suspend_Reactivate_Reset_Password.md` | Jira: FREIG-144 |
| US-882 | Super User: Per-User Activity View | DONE | 9 | US-874, US-880 | P1 — read-only, no new tracking infra. Shipped 2026-09-02, backend + frontend (Users tab). Story doc: `docs/business/stories/US-882_Super_User_Per_User_Activity_View.md` | Jira: FREIG-145 |
| US-883 | Platform Health Alerting (Webhook) | DONE | 9 | US-752 | P1 — Slack/email webhook, debounced, fail-open. Shipped 2026-09-02; backend-only, per its own Scope:BACKEND. Story doc: `docs/business/stories/US-883_Platform_Health_Alerting.md` | Jira: FREIG-146 |
| US-884 | Super User: Tenant Suspend/Deactivate | DONE | 9 | US-874, US-880 | P2 — access lock only, no billing/plan/deletion. Shipped 2026-09-02, backend + frontend (Dashboard tenant rows). Story doc: `docs/business/stories/US-884_Super_User_Tenant_Suspend_Deactivate.md` | Jira: FREIG-147 |
| US-885 | Super User: Scoped User Impersonation | DONE | 9 | US-874, US-880, US-881 | P3 — ships last, deliberately; time-boxed, re-auth, audit-logged. Shipped 2026-09-02, backend + frontend (2026-09-03 follow-up: real token-swap banner + Users-tab start control, corrected after user flagged the batch shipping backend-only against its own Scope:FULL_STACK). 2026-09-03: retroactive HFD audit performed after user flagged the whole batch skipped the HFD design phase (`/run-story` was never invoked) — see `docs/hfd/US-880-886_Super_User_Frontend_Retroactive_HFD_Audit.md`; 4 findings fixed (ad-hoc color, field order, missing aria-labels, missing live-region on the impersonation banner). REVIEWER/LIBRARIAN fresh-context gates remain unremediated debt. Story doc: `docs/business/stories/US-885_Super_User_Scoped_Impersonation.md` | Jira: FREIG-148 |
| US-886 | Super User: Create User (Existing Tenant or New Tenant) | DONE | 9 | US-874, US-880, US-881 | P1 — founder-identified gap. Shipped 2026-09-02, backend + frontend (Create User tab). Story doc: `docs/business/stories/US-886_Super_User_Create_User_And_Tenant.md` | Jira: FREIG-149 |
| US-887 | Security: Restrict Admin Self-Registration + Default Super User Bootstrap | DONE | 9 | — | P0 — critical, live production vulnerability. `POST /api/v1/auth/register` was unauthenticated and accepted `role=ADMIN` with zero restriction; anyone could self-register as platform Super User. Fixed 2026-09-03: rejected at the controller boundary, added idempotent `DefaultSuperUserBootstrapRunner` for legitimate first-admin creation. Story doc: `docs/business/stories/US-887_Restrict_Admin_Self_Registration.md` | Jira: FREIG-150 |
