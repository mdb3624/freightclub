# Force rebuild and deploy with timestamp tag
...
Write-Host "Building frontend with tag: $ImageTag" -ForegroundColor Cyan
docker build -f frontend/Dockerfile -t "$ImageRepo/freightclub-frontend:$ImageTag" -t "$ImageRepo/freightclub-frontend:latest" frontend/

Write-Host "Pushing image..." -ForegroundColor Cyan
docker push "$ImageRepo/freightclub-frontend:$ImageTag"
docker push "$ImageRepo/freightclub-frontend:latest"

Write-Host "Deploying with new image..." -ForegroundColor Cyan
