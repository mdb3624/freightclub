...
- Name: cost-profile-setup.spec.ts >> Carrier Cost Profile Setup — US-757 >> should handle zero MPG without division by zero error (US-757 AC-3)
- Location: e2e\cost-profile-setup.spec.ts:119:3
