...
- Name: us-824-quick-actions.spec.ts >> US-824: Quick Actions Panel >> US-824 AC-3: Get A Quote button navigates to /shipper/quote
- Location: e2e\us-824-quick-actions.spec.ts:107:3
...
Locator: locator('[data-testid="quick-actions-quote"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="quick-actions-quote"]')
  ...
  - generic [ref=e6]:
    ...
    - generic [ref=e15]:
      - button "Notifications" [ref=e17] [cursor=pointer]:
        - img [ref=e18]
      - button "QT" [ref=e22] [cursor=pointer]
  - generic [ref=e23]:
    - generic [ref=e24]:
