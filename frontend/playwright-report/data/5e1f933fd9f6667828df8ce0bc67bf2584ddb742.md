...
- Name: carrier-public-profile.spec.ts >> Carrier Public Profile - US-710 >> US-710 AC-2: Shipper compares carriers with benchmarks
- Location: e2e\carrier-public-profile.spec.ts:55:3
...
Locator: locator('[data-testid="carrier-benchmark-comparison"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="carrier-benchmark-comparison"]')
