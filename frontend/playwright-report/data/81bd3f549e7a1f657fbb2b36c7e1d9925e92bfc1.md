...
- Name: shipper-preferred-carriers.spec.ts >> Shipper Preferred Carrier List - US-707 >> AC-707-2: Shipper can view preferred carriers list
- Location: e2e\shipper-preferred-carriers.spec.ts:77:3
...
Locator: locator('text=Carrier Name')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Carrier Name')
