...
- Name: chg-003-action-zone-layout.spec.ts >> CHG-003: Action Zone Structural Layout >> AC-5: Panel structure matches master prototype with proper ARIA, spacing, and styling
- Location: e2e\chg-003-action-zone-layout.spec.ts:216:3
