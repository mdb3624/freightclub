...
- Name: carrier-public-profile.spec.ts >> Carrier Public Profile - US-710 >> US-710 AC-6: Shipper can add carrier to preferred list
- Location: e2e\carrier-public-profile.spec.ts:132:3
...
Locator: locator('[data-testid="add-to-preferred-btn"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="add-to-preferred-btn"]')
