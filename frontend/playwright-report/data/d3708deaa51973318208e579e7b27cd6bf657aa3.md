...
- Name: cost-profile-persistence-fix.spec.ts >> Cost Profile Persistence Fix Verification >> cost profile fields should be captured in form submission (TestDataSeeder)
- Location: e2e\cost-profile-persistence-fix.spec.ts:12:3
