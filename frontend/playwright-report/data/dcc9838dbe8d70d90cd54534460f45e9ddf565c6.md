...
- Name: shipper-dashboard-home.spec.ts >> Shipper Dashboard Home Golden Path (US-760/US-761/US-762) >> US-762 AC-1: carrier search panel performs a lane search and renders results state
- Location: e2e\shipper-dashboard-home.spec.ts:60:3
