...
- Name: admin-analytics-dashboard.spec.ts >> Admin Load Board Analytics Dashboard - US-704 >> Dashboard is accessible (keyboard navigation)
- Location: e2e\admin-analytics-dashboard.spec.ts:124:3
