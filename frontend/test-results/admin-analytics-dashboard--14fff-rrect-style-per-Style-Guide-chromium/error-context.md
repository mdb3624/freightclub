...
- Name: admin-analytics-dashboard.spec.ts >> Admin Load Board Analytics Dashboard - US-704 >> AC-1: Metric cards display correct style per Style Guide
- Location: e2e\admin-analytics-dashboard.spec.ts:79:3
