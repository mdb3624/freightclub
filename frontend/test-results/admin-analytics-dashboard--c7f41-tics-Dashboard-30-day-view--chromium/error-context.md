...
- Name: admin-analytics-dashboard.spec.ts >> Admin Load Board Analytics Dashboard - US-704 >> AC-1: Admin views Load Board Analytics Dashboard (30-day view)
- Location: e2e\admin-analytics-dashboard.spec.ts:54:3
