...
- Name: admin-analytics-dashboard.spec.ts >> Admin Load Board Analytics Dashboard - US-704 >> AC-2: Shipper Performance Insights displays correctly
- Location: e2e\admin-analytics-dashboard.spec.ts:94:3
