...
- Name: admin-analytics-dashboard.spec.ts >> Admin Load Board Analytics Dashboard - US-704 >> Dashboard loads within 2 seconds (performance requirement)
- Location: e2e\admin-analytics-dashboard.spec.ts:113:3
