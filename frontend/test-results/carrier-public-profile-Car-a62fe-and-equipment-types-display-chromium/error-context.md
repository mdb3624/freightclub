...
- Name: carrier-public-profile.spec.ts >> Carrier Public Profile - US-710 >> US-710 AC-5: Service areas and equipment types display
- Location: e2e\carrier-public-profile.spec.ts:115:3
...
Locator: locator('[data-testid="equipment-types-section"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="equipment-types-section"]')
