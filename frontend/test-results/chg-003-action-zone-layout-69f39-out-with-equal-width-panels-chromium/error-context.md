...
- Name: chg-003-action-zone-layout.spec.ts >> CHG-003: Action Zone Structural Layout >> AC-3: Desktop (≥1024px) displays 2-column grid layout with equal width panels
- Location: e2e\chg-003-action-zone-layout.spec.ts:117:3
