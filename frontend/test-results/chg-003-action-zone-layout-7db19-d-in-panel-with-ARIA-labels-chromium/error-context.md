...
- Name: chg-003-action-zone-layout.spec.ts >> CHG-003: Action Zone Structural Layout >> AC-2: Carrier Search section wrapped in .panel with ARIA labels
- Location: e2e\chg-003-action-zone-layout.spec.ts:74:3
