...
- Name: chg-003-action-zone-layout.spec.ts >> CHG-003: Action Zone Structural Layout >> AC-1: Quick Actions section wrapped in .panel with ARIA labels
- Location: e2e\chg-003-action-zone-layout.spec.ts:31:3
