...
- Name: chg-003-action-zone-layout.spec.ts >> CHG-003: Action Zone Structural Layout >> AC-4: Mobile (<1024px) displays single column vertical stack
- Location: e2e\chg-003-action-zone-layout.spec.ts:164:3
