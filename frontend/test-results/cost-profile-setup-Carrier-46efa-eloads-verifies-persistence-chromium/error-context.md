...
- Name: cost-profile-setup.spec.ts >> Carrier Cost Profile Setup — US-757 >> golden path: trucker enters all 10 cost fields, saves, reloads, verifies persistence
- Location: e2e\cost-profile-setup.spec.ts:12:3
