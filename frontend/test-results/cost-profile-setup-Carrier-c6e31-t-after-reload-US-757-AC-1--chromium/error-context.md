...
- Name: cost-profile-setup.spec.ts >> Carrier Cost Profile Setup — US-757 >> should save cost profile and persist after reload (US-757 AC-1)
- Location: e2e\cost-profile-setup.spec.ts:18:3
