...
- Name: hos-widget.spec.ts >> TruckerLandingPage CSS Migration >> ticker items have delta indicators with correct classes
- Location: e2e\hos-widget.spec.ts:104:3
...
- generic [ref=e3]:
  ...
  - banner [ref=e36]:
    ...
    - generic [ref=e38]:
      ...
      - generic [ref=e41]: Mon, May 18, 03:13 PM
  - navigation [ref=e42]:
...
```ts
  ...
  2   | 
  3   | const BASE_URL = 'http://localhost:9090'
  4   | 
