...
- Name: shipper-dashboard.spec.ts >> Shipper Dashboard Golden Path (US-715) >> should display summary cards with load statistics (US-715 AC-1)
- Location: e2e\shipper-dashboard.spec.ts:29:3
