...
- Name: shipper-dashboard.spec.ts >> Shipper Dashboard Golden Path (US-715) >> should filter loads using search input (US-715 AC-4)
- Location: e2e\shipper-dashboard.spec.ts:136:3
