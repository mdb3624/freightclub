...
- Name: shipper-dashboard.spec.ts >> Shipper Dashboard Golden Path (US-715) >> search functionality filters loads by Load ID
- Location: e2e\shipper-dashboard.spec.ts:71:3
