...
- Name: shipper-dashboard.spec.ts >> Shipper Dashboard Golden Path (US-715) >> should switch between Active and All Loads tabs (US-715 AC-3)
- Location: e2e\shipper-dashboard.spec.ts:102:3
