...
- Name: shipper-dashboard-framework.spec.ts >> US-821: Shipper Dashboard Framework Compliance >> framework structure and token compliance
- Location: e2e\shipper-dashboard-framework.spec.ts:13:3
