...
- Name: shipper-post-load.spec.ts >> Shipper Post Load — US-714 >> should match origin city to saved profile default (US-714 AC-2)
- Location: e2e\shipper-post-load.spec.ts:49:3
