...
- Name: shipper-profile-setup.spec.ts >> Shipper Profile Setup — US-713 >> US-713 AC-4: Profile displays all required and optional fields
- Location: e2e\shipper-profile-setup.spec.ts:145:3
...
Locator: locator('[data-testid="billing-email-input"]')
Expected: visible
Timeout: 5000ms
