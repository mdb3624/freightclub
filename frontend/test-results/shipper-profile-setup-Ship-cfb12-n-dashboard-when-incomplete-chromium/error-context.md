...
- Name: shipper-profile-setup.spec.ts >> Shipper Profile Setup — US-713 >> displays completion banner on dashboard when incomplete
- Location: e2e\shipper-profile-setup.spec.ts:99:3
