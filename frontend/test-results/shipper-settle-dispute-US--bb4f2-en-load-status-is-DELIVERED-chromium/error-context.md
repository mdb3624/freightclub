...
- Name: shipper-settle-dispute.spec.ts >> US-506 — Shipper Settle/Dispute Delivery >> shows Confirm Delivery block when load status is DELIVERED
- Location: e2e\shipper-settle-dispute.spec.ts:91:3
