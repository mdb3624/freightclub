...
- Name: theme-state-migration.spec.ts >> Theme State Migration — Golden Path (US-UI-MIGRATION) >> US-UI-MIGRATION AC-4/AC-5: shipper toggles theme mode on desktop track @US-UI-MIGRATION
- Location: e2e\theme-state-migration.spec.ts:70:3
