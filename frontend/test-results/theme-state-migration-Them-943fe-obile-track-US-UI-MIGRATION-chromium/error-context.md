...
- Name: theme-state-migration.spec.ts >> Theme State Migration — Golden Path (US-UI-MIGRATION) >> US-UI-MIGRATION AC-4/AC-6: carrier toggles theme mode on mobile track @US-UI-MIGRATION
- Location: e2e\theme-state-migration.spec.ts:37:3
