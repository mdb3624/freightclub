...
- Name: us-821-template-architecture.spec.ts >> US-821: Template-Driven Architecture Compliance >> AC-5: Assembly Rule - All content wrapped in panels
- Location: e2e\us-821-template-architecture.spec.ts:67:3
