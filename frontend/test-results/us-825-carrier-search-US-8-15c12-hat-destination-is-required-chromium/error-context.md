...
- Name: us-825-carrier-search.spec.ts >> US-825: Carrier Search Panel >> should validate that destination is required
- Location: e2e\us-825-carrier-search.spec.ts:113:3
